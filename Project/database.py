...
def send_images_example(vid1, vid2):
    ...
    public_url1 = sm.upload_file(file_name=f'taekwondo/{vid1}', local_path=vid1)
    public_url2 = sm.upload_file(file_name=f'taekwondo/{vid2}', local_path=vid2)
...
def send_data(file1, file2):
    public_url1 = sm.upload_file(file_name=f'taekwondo/{file1}', local_path=file1)
    public_url2 = sm.upload_file(file_name=f'taekwondo/{file2}', local_path=file2)
